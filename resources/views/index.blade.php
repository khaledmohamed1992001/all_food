                                    ...
                                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                                        <div class="card" style="border-radius: 15px;">
                                            <div class="card-body p-5">
                                                ...
                                                <form action="{{route('register')}}" method="POST" id="registeration">
                                                     @csrf
                                                    <div class="form-outline mb-4">
                                                        <input type="text"  name="name" id="form3Example1cg" class="form-control form-control-lg" required autocomplete="name" autofocus />
                                                        <label class="form-label" for="form3Example1cg">Your Name</label>
                                                    </div>

                                                    <div class="form-outline mb-4">
                                                        <input type="email"  name="email" id="form3Example3cg" class="form-control form-control-lg" required autocomplete="email" />
                                                        <label class="form-label" for="form3Example3cg">Your Email</label>
                                                    </div>

                                                    <div id="radio">
                                                        <label for="radio1"> <input type="radio" id="radio1" name="gen" value="Male" checked>
                                                        Male</label>
                                                        <label for="radio2"><input type="radio" id="radio2" name="gen" value="Female">
                                                        Female</label>
                                                   </div>
                                                    <label class="form-label" for="radio">Your gender</label>
                                                    <br>
                                                    <div class="form-outline mb-4">
                                                        <input type="password" name="password" id="form3Example4cg" class="form-control form-control-lg" required autocomplete="new-password" />
                                                    ...
                                                    <div class="form-check d-flex justify-content-center mb-5">
                                                        <input class="form-check-input me-2" style="left: 10%;" type="checkbox" value="" id="form2Example3cg" />
                                                        <label class="form-check-label" for="form2Example3g">
                                                            Keep me logged in <a href="#!" class="text-body"><u>Terms of service</u></a>
                                                        </label>
                                                    </div>
